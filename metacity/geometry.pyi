...
class MeshOIDMapper:
    def __init__(self, arg0: List[TriangularMesh]) -> None: ...
    def map_oids(self, arg0: TriangularMesh) -> None: ...
    @property
...
class MultiTimePoint(BaseModel):
    def __init__(self) -> None: ...
    def copy(self) -> MultiTimePoint: ...
    def deserialize(self, arg0: json) -> None: ...
    def map(self, arg0: MultiTimePointMapper) -> None: ...
    def serialize(self) -> json: ...
...
class TriangularMesh(Model):
    ...
    def map(self, arg0: TriangularMesh) -> None: ...
    def slice_to_grid(self, arg0: float) -> List[Model]: ...
    def slice_to_rect(self, arg0: float, arg1: float, arg2: float, arg3: float) -> Model: ...
    def to_obj(self, arg0: str, arg1: int) -> int: ...
    @property
    def type(self) -> str: ...
