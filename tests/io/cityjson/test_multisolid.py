...
from tests.data.cityjson import cubes_multisolid
...
def test_multisolid_all_defined():
...
def test_multisolid_some_semantics_not_defined():
    vertices, data = cubes_multisolid()
...
def test_multisolid_no_semantics():
    vertices, data = cubes_multisolid()
